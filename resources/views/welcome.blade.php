...
<body>
  ...
  <div class="container-fluid bg-success text-light p-0" style="background-color: lab(24.48% -28.75 15.86 / 0.833) !important;">
   ...
   style="display:flex; align-items:center; justify-content:flex-start; margin-right:auto; text-decoration:none;">

    <img src="img/logo.jpg" 
         alt="Logo" 
         style="height:80px; width:80px; object-fit:contain; display:block; margin-right:12px;">

    <span style="font-size:26px; font-weight:bold; color:black; line-height:1.2;">
    ...
    <div class="dropdown-menu bg-light m-0">
        <a href="feature.html" class="dropdown-item">History</a>
        <a href="appointment.html" class="dropdown-item">Mission & Vision</a>
        <a href="team.html" class="dropdown-item">Founder</a>
        <a href="testimonial.html" class="dropdown-item">Board of Trustees (BoT)</a>
        <a href="404.html" class="dropdown-item">Accreditation</a>
        <a href="404.html" class="dropdown-item">International Relation</a>
        ...
        <div style="position: relative;">
            <a href="#"
               ...
               onmouseenter="document.getElementById('gallerySubmenu').style.display='block'"
               onmouseleave="document.getElementById('gallerySubmenu').style.display='none'">
                Gallery <span>&#9658;</span>
            </a>
            <div id="gallerySubmenu"
                 style="display: none;
                        position: absolute;
                        top: 0;
                        left: 100%;
                ...
                <a href="event-gallery.html" class="dropdown-item">Event Gallery</a>
            </div>
        </div>
         <div style="position: relative;">
            <a href="#"
               class="dropdown-item"
               style="display: flex; justify-content: space-between; align-items: center;"
               onmouseenter="document.getElementById('authoritiesSubmenu').style.display='block'"
               onmouseleave="document.getElementById('authoritiesSubmenu').style.display='none'">
                Authorities <span>&#9658;</span>
            </a>
            <div id="authoritiesSubmenu"
                 style="display: none;
                        position: absolute;
                        top: 0;
                        left: 100%;
                 ...
                 onmouseenter="this.style.display='block'"
                 onmouseleave="this.style.display='none'">
                <a href="syndicate.html" class="dropdown-item">Syndicate</a>
                <a href="academic-council.html" class="dropdown-item">Academic Council</a>
            </div>
        </div>
         ...
         <div style="position: relative;">
            ...
            <div id="authoritiesSubmenu"
                 ...
                 onmouseenter="this.style.display='block'"
                 onmouseleave="this.style.display='none'">
                <a href="syndicate.html" class="dropdown-item">Academic Info</a>
                <a href="academic-council.html" class="dropdown-item">Academic Policy</a>
            </div>
        </div>
